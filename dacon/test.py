...
lig_model = LGBMRegressor(n_estimators=300, learning_rate=0.01, max_depth=9)

lig_model.fit(train_x, train_y)
y_pred = lig_model.predict(test_x)
...
# 
# # GridSearchCV를 위한 하이퍼파라미터 그리드를 정의합니다.
# param_grid = {
#     'iterations': [100, 200, 300, 500],
#     'depth': [3, 5, 7, 9],
#     'learning_rate': [0.01, 0.1, 0.2, 0.15],
# }
# 
...
# 
# # GridSearchCV를 수행합니다.
# grid.fit(train_x, train_y, verbose=False)
# 
# # 최적의 하이퍼파라미터를 출력합니다.
...
submission.to_csv('D://Dev//dacon//open//xgb_submission.csv', index=False)